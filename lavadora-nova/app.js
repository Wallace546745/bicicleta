...
(function () {
  ...
  const RELATED = [
    { img: 1, t: 'Carregador 48V 54,6V 2Ah para Bicicleta e Scooter Elétrica MBE4015', url: 'p/carregador-48v-2ah/', p: '14,90', old: '149,90', off: '90% OFF', sold: '+1000 vendidos', ship: 1, full: 1 },
    ...
    { img: 3, t: 'Bicicleta Elétrica Cavalletta C2 750W Bateria Removível 48V 20Ah 65 km', url: 'p/bicicleta-eletrica-cavalletta-c2/', p: '127,65', old: '6.097,00', off: '98% OFF', sold: '+100 vendidos', ship: 1, full: 1 },
    { img: 4, t: 'Capacete GTA Start com Pisca LED Sinalizador para Ciclismo e MTB', url: 'p/capacete-gta-start-led/', tag: 'Tam. M e G', p: '19,90', old: '139,99', off: '86% OFF', sold: '+5000 vendidos', ship: 1 },
    { img: 5, t: 'Mini Compressor Digital Rezzet Portátil com Calibrador para Carro, Bicicleta e Moto', url: 'p/mini-compressor-rezzet/', p: '22,60', old: '119,90', off: '81% OFF', sold: '+5000 vendidos', ship: 1, full: 1 },
    { img: 6, t: 'Caixa de Som JBL Boombox 4 Bluetooth 210W IP68 até 34h de Bateria Preta', url: 'p/caixa-de-som-jbl-boombox-4/', p: '99,90', old: '2.469,00', off: '96% OFF', sold: '+500 vendidos', ship: 1, full: 1 }
  ];
  const STORE = [
    { img: 4, t: 'Capacete GTA Start com Pisca LED Sinalizador para Ciclismo e MTB', url: 'p/capacete-gta-start-led/', tag: 'Tam. M e G', p: '19,90', old: '139,99', off: '86% OFF', sold: '+5000 vendidos', ship: 1 },
    { img: 5, t: 'Mini Compressor Digital Rezzet Portátil com Calibrador para Carro, Bicicleta e Moto', url: 'p/mini-compressor-rezzet/', p: '22,60', old: '119,90', off: '81% OFF', sold: '+5000 vendidos', ship: 1, full: 1 },
